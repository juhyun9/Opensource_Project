const qnaList = [
  ...
  },
  {
    ...
    a: [
      ...
      {
        answer:
          "b. (한줄씩 읽어보고) 제주 신화에서 제주도를 만들었다고 전해지는 여신이구나! 또…(사실 기반의 지식으로 기억해둔다.)",
        type: ["7", "3", "16", "17", "3", "14"],
      },
    ],
  },
  ...
  },
  {
    ...
    a: [
      {
        answer:
          "a. 아 그래…?ㅠㅜㅠ 나는 나름 괜찮은 것 같은데... 일단 남은 여행도 재밌게 마무리하자!",
        type: ['2','17','1','9'],
      },
      {
        answer:
          "b. 엥? 여태 잘다닌거 아니였어? 뭐가 문제였어?? 일단 남은 여행도 재밌게 마무리하자!",
        type: ["7", "9", "5", "9", "6", "2"],
      },
    ],
  },
  {
    ...
    a: [
      ...
      {
        answer:
          "b. 오! 대박이다. 여기 돌고래 보이는 명소인가? 무슨 주기가 있는건가??",
        type: ["1", "2", "9", "8", "6", "0"],
      },
    ],
  },

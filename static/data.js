const qnaList = [
  ...
  {
    q: '4. 올레길을 걷던 중 친구가 내게 말한다. 근데 26개의 올레길은 누가 만든거야? 이때 당신의 반응은?',
    a: [
      { type: [1, 3, 2, 10, 8] },
      { type: [7, 9, 11] },
    ]
  ...
  {
    q: '5. 황우치해변에서 뉴진스가 뮤직비디오를 촬영한뒤 쉬고있습니다. 몇몇 사람들이 가까이서 구경하고 환호하고 있습니다. 당신은 어떻게 행동하시겠습까?',
    a: [
      { type: [1, 3, 2, 10, 8] },
      { type: [7, 9, 11] },
    ]
  ...
  {
    q: '6. 올레길을 걷다가 발견한 사진 명소!! 인생샷 스팟 발견!!!',
    a: [
      { type: [1, 3, 2, 10, 8] },
      { type: [7, 9, 11] },
    ]
  ...
  {
    q: '7. 친구와 여행을 하던중 당신에게 이렇게 말합니다. 근데말이야, 우리 여행 취향 진짜 안맞는 것 같아. 이때 당신의 생각과 대답은?',
    a: [
      { type: [1, 3, 2, 10, 8] },
      { type: [7, 9, 11] },
    ]
  ...
  {
    q: '8. 제주도를 여행하던중..! 바다속 돌고래가 보인다 !! 이때 당신의 반응은?',
    a: [
      { type: [1, 3, 2, 10, 8] },
      { type: [7, 9, 11] },
    ]

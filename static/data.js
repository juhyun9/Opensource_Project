...
const infoList = [
  ...
  },
  {
    ...
    name: '추천 코스: 11코스 (무릉-가파도 올레)', // INTJ
    desc: '계획적이고 깊은 사고를 즐기시는편 이시군요!!. 무릉에서부터 가파도까지 이어지는 11코스는 어떠신가요?! 11코스는 고요하고 한적한 길을 따라 걷다가 가파도의 독특한 경관을 볼 수 있는 코스로, 당신의 사고와 사색을 자극할 수 있는 환경을 제공합니다. 이 코스는 고요한 해안길과 가파도의 독특한 풍경을 통해, 당신의 계획적인 사고와 사색을 깊게 할 수 있는 기회를 제공합니다.'
  },
  {

const qnaList = [
  {
    ...
    a: { Y: [0, 0, 0, 0, 1, 2, 1, 4], N: [0, 0, 0, 0, 1, 2, 2, 6] },
  },
  {
    q: "2. 좋아하는 사람이 생겨 연락하고자 한다 ",
    a: { Y: [0, 0, 0, 0, 0, 3, 2, 4], N: [0, 0, 0, 0, 1, 2, 6, 4] },
  },
  {
    q: "3. 당신의 고백 스타일은?",
    a: { Y: [0, 0, 0, 0, 1, 3, 0, 2], N: [0, 0, 0, 0, 7, 0, 1, 0] },
  },
];
...
const infoName = Object.keys(infoList); //key리스트
